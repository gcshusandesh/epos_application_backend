...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ratingCount: Attribute.Integer & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiGuestModePinGuestModePin extends Schema.SingleType {
  collectionName: 'guest_mode_pins';
  info: {
    singularName: 'guest-mode-pin';
    pluralName: 'guest-mode-pins';
    displayName: 'guestModePin';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    hasPin: Attribute.Boolean & Attribute.DefaultTo<false>;
    pinCode: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::guest-mode-pin.guest-mode-pin',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiProcessedOrderProcessedOrder extends Schema.CollectionType {
  collectionName: 'processed_orders';
  info: {
    singularName: 'processed-order';
    pluralName: 'processed-orders';
    displayName: 'ProcessedOrder';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::processed-order.processed-order',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSettingSetting extends Schema.SingleType {
  ...
  attributes: {
    ...
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    hasAdmin: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiUnitTypeUnitType extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::guest-mode-pin.guest-mode-pin': ApiGuestModePinGuestModePin;
      'api::inventory-item.inventory-item': ApiInventoryItemInventoryItem;
      'api::menu-item.menu-item': ApiMenuItemMenuItem;
      'api::processed-order.processed-order': ApiProcessedOrderProcessedOrder;
